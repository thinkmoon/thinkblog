...
lastmod: '2020-09-20 13:30:27'
categories:
- 学习笔记
tags:
- vuejs
description: Vue中的指令形如v-*，如v-if，v-show，v-model等。同时，除了Vue自带的一些默认指令外，Vue同时运行用户自定义指令，来扩展指令功能。
featured_image: http://blog.cdn.thinkmoon.cn/blog/typecho/2020-09-11T14:22:08.png
---
