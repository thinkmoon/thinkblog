---
title: 使用智谱api将长语音转文本
date: '2025-12-16 19:40:00'
lastmod: '2025-12-16 19:40:00'
categories:
- 技术实践
tags:
- 语音识别
...
- pyannote.audio
- Python
description: 智谱AI API虽性能优异但仅支持30秒以内音频文件。本文详细介绍如何基于pyannote.audio的语音活动检测技术实现智能音频分块，通过批量API调用构建完整的长语音转文本系统，包含完整的环境配置、代码实现和部署方案。
featured_image: https://cdn.jsdelivr.net/gh/thinkmoon/pic@master/images/20251217200921.png
---

![20251217200921](https://cdn.jsdelivr.net/gh/thinkmoon/pic@master/images/20251217200921.png)
