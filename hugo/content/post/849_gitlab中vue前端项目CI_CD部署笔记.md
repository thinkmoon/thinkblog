...
lastmod: '2020-06-23 19:34:48'
categories:
- 学习笔记
tags:
- gitlab
description: 持续部署（continuous deployment）是持续交付的下一步，指的是代码通过评审以后，自动部署到生产环境。持续部署的目标是，代码在任何时刻都是可部署的，可以进入生产阶段。
featured_image: http://blog.cdn.thinkmoon.cn/blog/typecho/2020-05-22T06:04:52.png
---
