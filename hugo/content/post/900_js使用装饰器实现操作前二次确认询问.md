...
- 前端
- javascript
description: 装饰器是对类、函数、属性之类的一种装饰，可以针对其添加一些额外的行为。本文介绍的是，如何js方法装饰器，封装二次确认弹框操作，增加小伙伴的开发效率。
featured_image: http://blog.cdn.thinkmoon.cn/blog/typecho/2020-08-03T08:01:10.png
---
